export const features = [
  {
    ...
    text: "Creating visually stunning and highly functional website tailored to your brand identity and audience needs.",
    button: {
...
export const details = [
  {
    ...
    title: "Graduated in SoftWare Engineering from stanford University",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "More than 5 Years of hands-on experience in web development projects",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "expert in building scalable, high-performance, and user-focused websites",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "web developer & Designer at xora company",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "What services does Neon Company offer?",
    answer:
      "We provide professional web design, web development, UI/UX design, and custom web solutions tailored to business needs",
  },
  {
    id: "1",
    question: "How long does it take to complete a website project?",
    answer:
      "Project timelines vary depending on complexity, but most websites are completed within 2 to 6 weeks.",
  },
  {
    id: "2",
  ...
  {
    id: "5",
    question: "What is the difference between Team, Overdrive, and Core plans",
    answer:
      "The Team plan is ideal for long-term collaboration, Overdrive is designed for urgent projects, and Core is best for small or standard website needs.",
  },
  {
    id: "6",
...
export const plans = [
  {
    ...
    features: [
      "Best for small businesses and single projects",
      "fixed timeline and clear deliverables",
      "5 projects",
      "24/7 support",
    ],
  ...
  },
  {
    ...
    features: [
      "best for Urgent and high-priority projects",
      "extended working hours for faster delivery",
      "Unlimited projects",
      "ideal for tight deadlines and fast launches",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "50% off per member",
      "Flexible project timeline and scalable",
    ],
